...
import {DeleteUser, GetAllUser} from "../../Api/UserApi.jsx";
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-800">Barcha foydalanuvchilar</h2>
                ...
                <div className="p-4">
                    <table className="w-full">
                        ...
                        <tr className="text-left bg-gray-50">
                            ...
                            <th className="p-3 text-gray-600"> User to'liq ismi</th>
